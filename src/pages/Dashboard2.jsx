...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col lg:flex-row mt-20">
      {/* Sidebar */}
      <aside className="w-full lg:w-64 bg-white shadow-md lg:h-screen">
        <div className="p-6">
          <FaUserCircle className="text-gray-700 text-4xl lg:text-6xl mx-auto" />
          <h2 className="mt-2 text-center text-xl lg:text-2xl font-bold">Welcome, User</h2>
        </div>
